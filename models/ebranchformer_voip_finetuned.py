...
CONFIG = {
    ...
    'conv_subsample_channels': 128,

    'cta_learnable_pooling': False,

    'cta_middle_channels': 16,
...
class CTAEBranchformer(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.pre_pool_norm = nn.LayerNorm(
            mfa_out_dim
        )
...
checkpoint = torch.load(
    "ebranchformer_voip_finetuned.pt",
    map_location=device,
    weights_only=False
)
...
print("EBranchformer-VoIP loaded successfully!")

# ==================================================================
# FEATURE EXTRACTION
# ==================================================================

def extract_ebranchformer_features(audio_path):
...
def get_ebranchformer_embedding(audio_path):

    features = extract_ebranchformer_features(
        audio_path
    )
